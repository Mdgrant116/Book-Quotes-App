...
struct QuotesViewModel {
    ...
    mutating func createQuotes() {
        quotes.append(Quote(author: "Stephen King", quote: "Monsters are real, and ghosts are real too. They live inside us, and sometimes, they win.", image: UIImage(named: "StephenKing") ?? UIImage()))
         ...
         quotes.append(Quote(author: "Kiese Laymon", quote: "I will wonder if the memories that remain with age are heavier than the ones we forget because they mean more to us, or if our bodies, like our nation, eventually purge memories we never wanted to be true."))
         quotes.append(Quote(author: "Matthew Quick", quote: "The bullies are always popular. Why? People love power."))
    }
}
